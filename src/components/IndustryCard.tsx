...
const IndustryCard: FC<IndustryCardProps> = ({ industry, bgImage }) => {
  return (
    <div
      className="relative flex items-center justify-between container p-8 rounded-3xl shadow-lg overflow-hidden 
      ...
      {/* Industry Text */}
      <div className="z-10 text-white text-lg font-semibold">{industry}</div>
