    ...
    <nav className="bg-black text-white py-4">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
        ...
        <div className="flex space-x-4">
          <a href="https://www.linkedin.com/company/redactmedia/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors">
          ...
          <a href="https://www.tiktok.com/@redactmedia" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors">
